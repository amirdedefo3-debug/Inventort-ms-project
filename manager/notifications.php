...
if (isset($_GET['clear'])) { mysqli_query($conn, "DELETE FROM notifications"); header("Location: notifications.php"); exit; }
...
<div class="content">
  <div class="card">
    <div class="card-header">
      <h3>🔔 Notifications (<?=mysqli_num_rows($notifs)?>)</h3>
      <a href="?clear=1" class="btn btn-sm btn-danger" onclick="return confirm('Clear all?')">🗑️ Clear All</a>
    </div>
