...
<div class="content">
  <div class="card">
    <div class="card-header">
      <h3>🔔 All Notifications (<?=mysqli_num_rows($notifs)?>)</h3>
      <a href="?clear=1" class="btn btn-sm btn-danger" onclick="return confirm('Clear all notifications?')">🗑️ Clear All</a>
    </div>
    <div class="table-responsive">
      <table>
        ...
        while ($r = mysqli_fetch_assoc($notifs)):
            $ic = $icons[$r['type']] ?? 'ℹ️';
            $bc = $badge[$r['type']] ?? 'b-info';
        ?>
        <tr>
